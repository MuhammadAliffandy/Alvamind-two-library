...
import '../../../view/screens/molecules/authentications/modal_bottom.dart';
import '../../../view/screens/molecules/student_registration/form_student_registration.dart';
import '../../atom/my_asset_image.dart';
import '../../atom/my_custom_button.dart';
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                        ...
                        right: 10,
                        child:
                            GestureDetector(onTap: () => Navigator.of(context).pop(context), child: Icon(Icons.close)))
                  ],
                ),
              ),
              SizedBox(
