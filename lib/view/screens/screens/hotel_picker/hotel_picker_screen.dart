...
import '../../../../widget/atom/my_custom_text.dart';
import '../../../../widget/atom/my_image_short_card.dart';
import '../../../../widget/atom/my_short_card.dart';
import '../../../../widget/organism/hotel_picker/content_not_ready.dart';
import '../../../../widget/organism/hotel_picker/hp_content_ready.dart';
                    ...
                    Row(
                      children: [
                        GestureDetector(
                          ...
                          child: MyImageShortCard(state: i == 0, text: "Semua", pathImage: AppAssets.dashboardIconPath),
                        ),
                        const SizedBox(
                          width: 10,
                        ),
